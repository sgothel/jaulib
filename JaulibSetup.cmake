...
if(JAU_CMAKE_OVERRIDE_INSTALL_PREFIX)
    if (DEBUG)
        set(CMAKE_INSTALL_PREFIX "${PROJECT_SOURCE_DIR}/dist/default-debug" CACHE PATH "" FORCE)
    else()
        set(CMAKE_INSTALL_PREFIX "${PROJECT_SOURCE_DIR}/dist/default-release" CACHE PATH "" FORCE)
    endif()
    message(STATUS "JaulibSetup: Setting CMAKE_INSTALL_PREFIX ${CMAKE_INSTALL_PREFIX}")
endif()
set(CMAKE_INSTALL_PREFIX "${CMAKE_INSTALL_PREFIX}-${OS_AND_ARCH}-${TOOLSET}" CACHE PATH "" FORCE)
